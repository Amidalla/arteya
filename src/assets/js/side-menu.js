export function InitSideMenu() {
    ...
    document.querySelectorAll('.side-menu__link').forEach(link => {
        link.addEventListener('click', function(e) {
            ...
            const sublist = parentItem ? parentItem.querySelector('.side-menu__sublist') : null;
    ...
    document.querySelectorAll('.side-menu__subitem.dropdown .side-menu__sublink').forEach(sublink => {
        sublink.addEventListener('click', function(e) {
            ...
            const additionalList = parentSubitem ? parentSubitem.querySelector('.side-menu__additional-list') : null;
    ...
    document.addEventListener('click', function(e) {
        if (!sideMenu.contains(e.target)) {
            ...
            document.querySelectorAll('.side-menu__sublink.active').forEach(sublink => {
                ...
                const additionalList = sublink.closest('.side-menu__subitem')?.querySelector('.side-menu__additional-list');
    ...
    function closeAllNestedMenus(parentItem) {
        ...
        parentItem.querySelectorAll('.side-menu__sublink.active').forEach(activeSublink => {
            ...
            const activeAdditionalList = activeSublink.closest('.side-menu__subitem')?.querySelector('.side-menu__additional-list');
